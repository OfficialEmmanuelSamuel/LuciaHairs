...
const Footer = ({ scrollToSection }) => {
  ...
  return (
    <footer className="w-full bg-gray-100 text-gray-300 pt-12 pb-6 px-6">
        <div className="max-w-6xl mx-auto gap-8 grid grid-cols-1 md:grid-cols-2 sm:grid-cols-3  lg:grid-cols-4 ">
            ...
            <div>
                <div className='flex items-center space-x-2'>
                    ...
                    />
                    <h3 className="font-nimbus bg-gradient-to-r from-gray-700 to-pink-600 bg-clip-text text-transparent text-lg cursor-pointer">Lucia Hairs</h3>
                </div>
                
                <p className="mt-3 text-sm text-gray-900 font-quicksand font-semibold leading-7">
            ...
            <div className='lg:flex flex-col items-center sm:flex-col'>
                <h4 className="flex items-center text-sm font-quicksand font-semibold mb-3 text-pink-700">
                    QUICK LINKS<IoLinkOutline className="ml-2" />
                </h4>
                <ul className='flex flex-col gap-3 font-quicksand text-gray-900 font-medium'>
            ...
            <div className='lg:flex flex-col items-center sm:flex-col'>
                ...
                <ul className='flex flex-col gap-3 font-nunito text-gray-900 font-medium'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className="flex items-center gap-5">
                    ...
                    <a href="mailto:luciahairss@gmail.com" className='text-black w-5 h-5 flex items-center justify-center rounded-full shadow-lg text-6xl transition'><IoMail size={23} /></a>
                </div>
                <div className='flex items-center gap-3 mt-5 font-quicksand text-gray-900 text-sm'>
        ...
        <div className="max-w-6xl mx-auto mt-20 border-t border-gray-700 pt-4 text-center text-sm text-gray-500 font-quicksand font-semibold">
