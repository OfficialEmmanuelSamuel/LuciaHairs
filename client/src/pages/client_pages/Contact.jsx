...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    emailjs
      .sendForm("Emanel_service", "Emanel001", e.target, "Au6iMYPaNtMkzDG6n")
      .then(
        (result) => {
  ...
  return (
    <section
      id="Contact"
      className="bg-red-00 mb-10 min-h-screen flex items-center justify-center"
    >
      <div className="w-full flex flex-col items-center mx-auto px-2 mt-30">
        <p className="font-lighter text-gray-800 mx-auto mb-5 font-nunito text-lg lg:hidden">
          Write Us A Message!
        </p>
        <div className="max-w-4xl flex flex-col items-center gap-2 p-2 sm:flex-row lg:flex-row">
          <div className="bg-cover w-full flex flex-col items-center lg:shadow-md lg:h-90 lg:w-2xl">
            <p className="hidden font-lighter text-gray-800 mb-5 font-nunito text-lg lg:flex">
              Write Us A Message!
            </p>
          ...
          <form
            ...
            className="bg-white shadow-md rounded-lg p-5 space-y-2"
          >
            <input
              type="text"
              name="name"
